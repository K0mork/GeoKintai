...
|---|---|---|---|---|---|---|
| FR-01 | 仕事場 CRUD | AC-01 | `WorkplaceRepositoryTests`, `AppStoreIntegrationTests` | T-011 | P1-010, P1-020, P2-030 | In Progress |
...
| FR-09 | 権限不足時安全動作 | AC-09 | `PermissionUseCaseTests`, `RegionMonitoringSyncServiceTests`, `AppStoreIntegrationTests` | T-012, T-013 | P2-050, P3-022 | In Progress |
